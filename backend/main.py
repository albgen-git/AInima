...
from routers import (
    account, admin, admin_viewer, auth, contacts, engagement, feedback, internal_cron, matching,
    payments, personal_report, preferences, profile, psychometric, torneo_estetico,
)
...
app.include_router(torneo_estetico.router)
