...
export { torneoEsteticoApi } from "./torneoEstetico";

/**
 * URL assoluto per mostrare una foto. `foto_profilo_url` (o una delle 10
 * `foto_preferenza_urls` del torneo estetico) è un path relativo allo
 * storage locale del backend (servito da /photos/,
